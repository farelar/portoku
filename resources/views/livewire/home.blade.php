...
<div>
    <!-- Hero Section -->
    <section id="home" class="min-h-screen flex items-center bg-linear-to-br from-blue-50 to-indigo-100">
            ...
            <div>
                ...
                <div class="grid grid-cols-3 gap-6">
                    ...
                    <div class="text-center group">
                        ...
                        <p class="mt-2 font-semibold text-gray-700">Alpine.js</p>
                    </div>

                    <!-- Tailwind CSS -->
                    <div class="text-center group">
                        <div class="bg-[#171e31] p-4 rounded-2xl shadow-lg group-hover:scale-110 transition-transform duration-300 w-24 h-20 sm:w-40 sm:h-24 md:w-28 md:h-20 lg:w-40 lg:h-20  flex items-center justify-center mx-auto">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" class="w-10 h-10">
